          ...
          <div className="col-lg-12">
            <div className="banner-box">
              ...
              <p className="banner-description">
                ...
                pas. I'm here and I won't let you fall. I'm here! ♥️
              </p>
              <p className="banner-description">Made with love, for you. ♥️</p>
              <p className="banner-description">Tons of hugssssssss!!! ♥️</p>
            </div>
          </div>
        </div>
      </div>
